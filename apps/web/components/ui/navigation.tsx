...
export function NavigationMenu({
  ...
  return (
    <nav
      className={cn(navClasses[orientation], className)}
      {...props}
    >
...
export function MobileNavigation({
  ...
  return (
    <div className={cn("lg:hidden", className)} {...props}>
      ...
      {isOpen && (
        <div className="fixed inset-x-0 top-16 z-50 h-[calc(100vh-4rem)] bg-background border-t">
          <NavigationMenu
            items={items}
          ...
          {items.map((item, index) => {
            ...
            return (
              <li key={index}>
                ...
                >
                  {item.icon && (
                    <span className={cn("shrink-0", !isCollapsed && "mr-3")}>
                      {item.icon}
                    </span>
                  )}
                  {!isCollapsed && (
                    <>
                      ...
                      {item.label && (
                        <span className="ml-auto rounded-md bg-primary/10 px-2 py-1 text-xs text-primary">
                          {item.label}
                        </span>
                      )}
                    </>
