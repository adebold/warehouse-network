      ...
      <div className="rounded-lg border border-destructive bg-destructive/10 p-4">
        <div className="flex items-start">
          ...
          <div className="ml-3 flex-1">
            <h3 className="text-sm font-medium text-destructive">Account Locked</h3>
    ...
    return (
      <div className="rounded-lg border border-warning bg-warning/10 p-4">
        <div className="flex items-start">
          ...
          <div className="ml-3 flex-1">
            <h3 className="text-sm font-medium text-warning">Account Suspended</h3>
    ...
    return (
      <div className="rounded-lg border border-warning bg-warning/10 p-4">
        <div className="flex items-start">
          ...
          <div className="ml-3 flex-1">
            <h3 className="text-sm font-medium text-warning">Payment {paymentStatus === 'OVERDUE' ? 'Overdue' : 'Delinquent'}</h3>
            <div className="mt-2 text-sm text-warning/90">
              Please update your payment to avoid service interruption.
            </div>
            {overdueAmount && overdueAmount > 0 && (
              <div className="mt-2 text-sm font-medium text-warning">
