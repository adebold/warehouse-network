...
app.get('/api/inventory', (req, res) => {
  res.json([
    { id: 1, sku: 'WH001', name: 'Storage Unit A', quantity: 150, warehouseId: 1, status: 'Available' },
    { id: 2, sku: 'WH002', name: 'Storage Unit B', quantity: 89, warehouseId: 2, status: 'Available' },
    { id: 3, sku: 'WH003', name: 'Storage Unit C', quantity: 203, warehouseId: 3, status: 'Available' }
  ]);
});
